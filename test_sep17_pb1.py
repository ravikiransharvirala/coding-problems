...
to S by any number of applications of the following extension operation: choose a 
group consisting of characters c, and add some number of characters c to the group 
...
From Akashdeep Singh to Everyone: (6:35 PM)
Example:
Input: 
S = "heeellooo" 
words = ["hello", "hi", "helo"]
